...
class SignupForm(UserCreationForm):
    ...
    password1 = forms.CharField \
        (widget=forms.TextInput(attrs={"placeholder": "Entrer votre mot de passe", 'type' : 'password'}), label=_("Password"))
    password2 = forms.CharField \
        (widget=forms.TextInput(attrs={"placeholder": "Confirmer votre mot de passe", 'type' : 'password'}), label=_("Confirm Password"))
